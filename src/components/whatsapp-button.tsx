  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      >
        ...
        <span className="absolute inset-0 rounded-full bg-emerald-500 animate-whatsapp-ping" />
        <span className="absolute inset-0 rounded-full bg-emerald-500 animate-whatsapp-ping [animation-delay:0.6s]" />
